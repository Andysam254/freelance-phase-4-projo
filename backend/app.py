...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://freelance_board_db_user:ixmGs6833Uto6zckJaDekxGJpEfwd73N@dpg-cugnbrqj1k6c73avps4g-a.oregon-postgres.render.com/freelance_board_db'
db.init_app(app)
